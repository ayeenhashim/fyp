...
<div class="form">
<p>HYE <?php echo $_SESSION['username']; $id = $_REQUEST["id"] ?>!</p>
...
<?php
$count=1;
$sel_query="SELECT * from `student` WHERE ref_id='".$id."'";
// echo $sel_query;
...
?>
<tr>
<td align="center"><?php echo str_pad($row["stu_id"], 4, "0", STR_PAD_LEFT); ?></td>
