...
<input type="text" name="stu_ic" placeholder="Enter Student IC" required /></p>
<input type="password" name="pass" placeholder="Enter Password" required /></p>
<p><input type="text" name="address" placeholder="Enter Address" required />
<input type="text" name="contact" placeholder="Enter Contact" required /></p>
<p>
	<input type="text" name="ref" placeholder="referrer user id">
</p>
...
$insert_data=mysqli_query($con,"insert into student(name,stu_ic,password,address,contact,ref_id) values ('$name','$stu_ic','$pass','$address','$contact','$ref')");
if($insert_data){
